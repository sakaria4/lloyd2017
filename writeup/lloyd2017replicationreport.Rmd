...
Paird T-test between measurement of truth biases for black targets and white targets
...
setwd("C:/Users/sakar/Desktop")

lloyd1c <- read_excel("lloyd20171cdata.xlsx")
...
```{r}
filtered_lloyd1c = lloyd1c %>% 
  filter(!is.na(filter) & filter == 1 & Ps != 63)
```

```{r}
View(filtered_lloyd1c)
```
...
#Statistic that was reported
t.test(filtered_lloyd1c$Bcrit, filtered_lloyd1c$Wcrit, paired = TRUE)
